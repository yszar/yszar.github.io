...
所以如果所有的配置都使用完整路径的话，就不需要 `chdir` 了。
## 配置项
...
可以[使用 Let's Encrypt 生成免费的 SSL 证书](https://tangjiuyang.com/mysite/apply-for-lets-via-acmesh.html)。
# 其他
## 使用域名时
